...
button.addEventListener("click", function () {
    ...
    if (username === secretUsername && password === secretPassword) { message.innerHTML = "Success!"; }
    ...
    else if (username === secretUsername && password !== secretPassword) { message.innerHTML = "Wrong password - be careful, don't mess this up too many times."; }
    else if (username !== secretUsername && password === secretPassword) { message.innerHTML = "Wrong username - is there a typo?"; }
    else if (username === "" && password === "") { message.innerHTML = "You need to enter SOMETHING."; }
    else { message.innerHTML = "Incorrect username and password. Hmm. Suspicious."; }
    console.log(message);
